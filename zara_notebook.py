...
st.title("Welcome to Zara Details!", text_alignment="center")
st.subheader(":red[DISCLAIMER!]", text_alignment="center")
st.write("This was made using a practice dataset and therefore does not reflect true Zara statistics.")
...
st.subheader("Range of ages that shop at Zara")
...
st.write("We can see that Zara's sales suggest that Zara has a continous cycle of low sales and high values with outliers skewed toward the lower end.\nHowever, I'd like to prove that next below")
...
We can conclude that Zara's sales rely on high quantity, low price over high price, low quantity.\n 
This leads me to believe that Zara should focus on advertising its cheaper options creating more revenue.""")
...
st.write("""
Zara's sales fluctuate regularly but their highest selling quantities remain in their cheap items. These cheap items are often bought in bulk allowing for a higher return on investment.
Despite clothing being synonymous with Zara's branding, they have electronics to support their sales targets with enough of a male and female demographic to continue successfully. 
""")